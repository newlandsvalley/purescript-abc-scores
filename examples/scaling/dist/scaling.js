(() => {
  ...
  var manyRec = function(dictMonadRec) {
    ...
    return function(dictAlternative) {
      ...
      return function(p) {
        var go = function(acc) {
          return bind1(alt5(map111(Loop.create)(p))(pure12(new Done(unit))))(function(aa) {
  ...
  var brokenRhythmPair = /* @__PURE__ */ function() {
    return withError(apply4(apply4(map14(BrokenRhythmPair.create)(graceableNote))(brokenRhythmTie))(graceableNote))("broken rhythm pair");
  }();
  var note = /* @__PURE__ */ function() {
    return map14(Note.create)(graceableNote);
  }();
  var restOrNote = /* @__PURE__ */ function() {
    return alt4(map14(Left.create)(abcRest))(applyFirst3(map14(Right.create)(graceableNote))(whiteSpace));
  }();
  var tuplet = /* @__PURE__ */ bind5(/* @__PURE__ */ optionMaybe(graceBracket))(function(maybeGrace) {
    return bind5(tupletBrackets)(function(leftBracketCount) {
      ...
      return bind5(tupletSignature)(function(signature) {
        return bind5(counted(signature.r)(restOrNote))(function(restsOrNotes) {
  ...
  var scoreItem = /* @__PURE__ */ withError(/* @__PURE__ */ choice2([/* @__PURE__ */ $$try(chord), /* @__PURE__ */ $$try(inline), continuation, /* @__PURE__ */ $$try(decoratedSpace), ignore, spacer, /* @__PURE__ */ $$try(annotation), chordSymbol, /* @__PURE__ */ $$try(tuplet), rest, /* @__PURE__ */ $$try(brokenRhythmPair), /* @__PURE__ */ $$try(note)]))("score item");
  ...
  var all3 = /* @__PURE__ */ all(foldableList)(heytingAlgebraBoolean);
  ...
  var normaliseChord = function(abcChord2) {
    ...
    ;
    var notes2 = map17(function(n) {
      return {
        duration: mul2(n.duration)(abcChord2.duration),
  ...
  var isEmptyStave = function(bars2) {
    var isEmptyBar = function(bar3) {
      ...
      return all3(f)(bar3.music) || $$null2(bar3.music);
    };
    return all3(isEmptyBar)(bars2);
  };
  var getTitle = function(tune) {
    return firstOf(function($40) {
      return _headers4(traversed4(_Title2($40)));
    })(tune);
  };
  var dotFactor = function(i) {
    ...
    ;
    if (i === 2) {
      return toRational3(3)(4);
    }
    ;
    if (i === 3) {
      return toRational3(7)(8);
    }
    ;
    return toRational3(0)(1);
  };
  ...
  var beatDuration = function(ts) {
    if (ts.numerator === 3 && ts.denominator === 2) {
      return toRational4(1)(2);
    }
    ;
    if (ts.numerator === 6 && ts.denominator === 8) {
      return toRational4(3)(8);
    }
    ;
    ...
    ;
    return toRational4(1)(ts.denominator);
  };
  ...
  var graceLength = function(maybeGraceNote) {
    return fromMaybe(0)(map18(function(g) {
  ...
  var getRorNsGraceLength = function(rOrNs) {
    var f = function(acc) {
      return function(rOrN) {
        ...
        ;
        throw new Error("Failed pattern match at VexFlow.Abc.TickableContext (line 117, column 7 - line 121, column 53): " + [rOrN.constructor.name]);
      };
    };
  ...
  var getRorNsDuration = function(rOrNs) {
    var f = function(acc) {
      return function(rOrN) {
        ...
        ;
        throw new Error("Failed pattern match at VexFlow.Abc.TickableContext (line 107, column 7 - line 109, column 68): " + [rOrN.constructor.name]);
      };
    };
  ...
  var getTickableContext = function(m) {
    ...
    if (m instanceof Chord) {
      ...
      var duration = mul3(m.value0.duration)(abcNote2.duration);
      return new TickableContext(1, 0, duration);
    }
    ;
    if (m instanceof BrokenRhythmPair) {
      return new TickableContext(2, graceLength(m.value0.maybeGrace) + graceLength(m.value2.maybeGrace) | 0, add1(m.value0.abcNote.duration)(m.value2.abcNote.duration));
    }
    ;
    if (m instanceof Tuplet) {
      var reduction = toRational5(m.value0.signature.q)(m.value0.signature.p);
      var graceNoteLength = getRorNsGraceLength(toUnfoldable6(m.value0.restsOrNotes));
      var duration = mul3(reduction)(getRorNsDuration(toUnfoldable6(m.value0.restsOrNotes)));
  ...
  var traversed5 = /* @__PURE__ */ traversed(traversableList)(/* @__PURE__ */ wanderForget(monoidFirst));
  ...
  var getUnitNoteLength = function(tune) {
    return firstOf(function($14) {
      return _headers5(traversed5(_UnitNoteLength2($14)));
    })(tune);
  };
  ...
  var traversed7 = /* @__PURE__ */ traversed(traversableList);
  var traversed12 = /* @__PURE__ */ traversed7(/* @__PURE__ */ wanderForget(monoidFirst));
  ...
  var traversed22 = /* @__PURE__ */ traversed7(/* @__PURE__ */ wanderForget(monoidLast));
  ...
  var updateAbcContext = function(abcContext) {
    return function(change) {
      ...
      ;
      throw new Error("Failed pattern match at VexFlow.Abc.Utils (line 196, column 3 - line 220, column 10): " + [change.constructor.name]);
    };
  };
  var noteTicks = function(unitNoteLength2) {
    return function(d) {
      return round2(toNumber3(mul4(mul4(unitNoteLength2)(d))(fromInt2(128))));
    };
  };
  ...
  var normaliseBroken = function(broken) {
    return function(gn1) {
      return function(gn2) {
        var up = function(i) {
          return add2(fromInt2(1))(dotFactor(i));
        };
        var down = function(i) {
          return sub2(fromInt2(1))(dotFactor(i));
        };
        if (broken instanceof LeftArrow) {
          var righta = {
            duration: mul4(gn2.abcNote.duration)(up(broken.value0)),
          ...
          var lefta = {
            duration: mul4(gn1.abcNote.duration)(down(broken.value0)),
        ...
        if (broken instanceof RightArrow) {
          var righta = {
            duration: mul4(gn2.abcNote.duration)(down(broken.value0)),
            accidental: gn2.abcNote.accidental,
            octave: gn2.abcNote.octave,
            pitchClass: gn2.abcNote.pitchClass,
            tied: gn2.abcNote.tied
          ...
          var lefta = {
            duration: mul4(gn1.abcNote.duration)(up(broken.value0)),
            accidental: gn1.abcNote.accidental,
            octave: gn1.abcNote.octave,
            pitchClass: gn1.abcNote.pitchClass,
            tied: gn1.abcNote.tied
        ...
        ;
        throw new Error("Failed pattern match at VexFlow.Abc.Utils (line 137, column 5 - line 156, column 71): " + [broken.constructor.name]);
      };
    };
  };
  var nextStaveNo = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at VexFlow.Abc.Utils (line 230, column 1 - line 230, column 38): " + [v.constructor.name]);
  };
  var isEmptyMusicSpec = function(v) {
    return $$null(v.noteSpecs) && $$null(v.repetitions);
  };
  var getComposerAndOrigin = function(tune) {
    var origin2 = firstOf(function($87) {
      return _headers7(traversed12(_Origin2($87)));
    })(tune);
    ...
    var composer2 = firstOf(function($88) {
      return _headers7(traversed12(_Composer2($88)));
    })(tune);
    var $68 = isNothing(composer2);
    if ($68) {
      return origin2;
    }
    ;
    var $69 = isNothing(origin2);
    if ($69) {
      return composer2;
    }
    ;
    return apply5(map19(frameAndCombine)(composer2))(origin2);
  };
  var getBarFill = function(timeSignature2) {
    return function(unitNoteLength2) {
      return function(v) {
        var signatureDuration = toRational6(timeSignature2.numerator)(timeSignature2.denominator);
        var barDuration = mul4(unitNoteLength2)(v.value2);
        var $73 = eq5(barDuration)(fromInt2(0));
        if ($73) {
          return Empty.value;
        }
        ;
        var $74 = eq5(barDuration)(signatureDuration);
        if ($74) {
          return Full.value;
        }
        ;
        var $75 = greaterThan2(barDuration)(signatureDuration);
        if ($75) {
  ...
  var buildTempo = function(bpm) {
    return function(d) {
      ...
      ;
      throw new Error("Failed pattern match at VexFlow.Abc.Utils (line 105, column 3 - line 109, column 15): " + [v.constructor.name]);
    };
  };
  var tempoMarking = function(tempoSig) {
    var tempoNoteLength = foldl7(add2)(fromInt2(0))(tempoSig.noteLengths);
  ...
  var getVoiceClef = function(tune) {
    ...
    var clefString = join3(lastOf(function($89) {
      return _headers7(traversed22(_Voice2(_properties2(_clef1($89)))));
    })(tune));
    return map19(f)(clefString);
  };
  var initialAbcContext = function(tune) {
    return function(config2) {
      var unitNoteLength2 = fromMaybe(toRational6(1)(8))(getUnitNoteLength(tune));
      var timeSignature2 = getDefaultedMeter(tune);
      var modifiedKeySignature = fromMaybe(cMajor)(map19(identity11)(getKeySig(tune)));
      var mTempo = maybe(Nothing.value)(tempoMarking)(getTempoSig(tune));
      var clef = fromMaybe(Treble.value)(getVoiceClef(tune));
      var $86 = $$null2(modifiedKeySignature.modifications);
      if ($86) {
        return new Right({
    ...
    return function(noteIndex) {
      return function(mBeatMarker) {
        return function(gn1) {
          return function(gn2) {
            return function(ens) {
              var slurBrackets = append13(buildSlurBrackets(noteIndex)(gn1.leftSlurs)(gn1.rightSlurs))(buildSlurBrackets(noteIndex + 1 | 0)(gn2.leftSlurs)(gn2.rightSlurs));
              return map20(function(ns) {
                return {
                  noteSpecs: ns,
                  tuplets: [],
                  ties: [],
    ...
    return function(gn1) {
      return function(broken) {
        return function(gn2) {
          ...
          var enote2 = graceableNote2(context)(v.value1);
          var enote1 = graceableNote2(context)(v.value0);
      ...
      return function(noteIndex) {
        return function(phraseDuration) {
          return function(m) {
            ...
            var barFraction = mul5(phraseDuration)(context.unitNoteLength);
            ...
            if (m instanceof Tuplet) {
              ...
              return map20(function(tupletSpec) {
                return {
  ...
  var functorExceptT = function(dictFunctor) {
    ...
    return {
      map: function(f) {
        return mapExceptT(map111(map23(f)));
      }
    };
  };
    ...
    return function(renderer) {
      return function(tune) {
        return function(eStaveSpecs) {
          ...
          ;
          throw new Error("Failed pattern match at VexFlow.Score (line 189, column 3 - line 197, column 56): " + [eStaveSpecs.constructor.name]);
        };
      };
    };
  };
  var renderUntitledScore = function(renderer) {
    return function(eStaveSpecs) {
      ...
      ;
      throw new Error("Failed pattern match at VexFlow.Score (line 175, column 3 - line 180, column 56): " + [eStaveSpecs.constructor.name]);
    };
  };
  var createScore = function(config2) {
    return function(abcTune) {
      ...
      ;
      throw new Error("Failed pattern match at VexFlow.Score (line 136, column 3 - line 140, column 42): " + [v.constructor.name]);
    };
  };
  var renderFinalTune = function(config2) {
    return function(renderer) {
      return function(abcTune) {
        ...
        var $44 = config$prime.width > config2.width;
        if ($44) {
          return pure11(new Just("Canvas width exceded"));
        }
        ;
        return function __do() {
  ...
  var scaleConfigToDesiredWidth = function(abcTune) {
    return function(config2) {
      return function(desiredWidth) {
        ...
        var scaleFactor = toNumber2(desiredWidth) / toNumber2(justifiedConfig.width);
        var newHeight = floor2(toNumber2(justifiedConfig.width) * scaleFactor);
        var newScale = justifiedConfig.scale * scaleFactor;
        var newWidth = floor2(toNumber2(justifiedConfig.width) * scaleFactor);
        return {
  ...
  // output/Examples.Scaling.Main/index.js
  ...
  var main = /* @__PURE__ */ function() {
    ...
    if (v instanceof Right) {
      return function __do() {
        ...
        return renderFinalTuneAtWidth(config)(500)(renderer)(v.value0)();
      };
    }
    ;
