...
(() => {
              ...
              function go(bot, top3) {
                switch (top3 - bot) {
                  ...
                  default:
                    ...
                    return apply5(map26(concat2)(go(bot, pivot)))(go(pivot, top3));
                }
              }
  ...
  var traversableNonEmpty = function(dictTraversable) {
    ...
    return {
      sequence: function(dictApplicative) {
        ...
        return function(v) {
          return apply5(map26(NonEmpty.create)(v.value0))(sequence12(v.value1));
        };
      },
      traverse: function(dictApplicative) {
        var Apply0 = dictApplicative.Apply0();
        ...
        return function(f) {
          return function(v) {
            return apply5(map26(NonEmpty.create)(f(v.value0)))(traverse12(f)(v.value1));
          };
        };
      },
      Functor0: function() {
  ...
  var whiteSpace = /* @__PURE__ */ map14(function($80) {
    return fromCharArray(fromFoldable4($80));
  ...
  var chordSymbol = /* @__PURE__ */ withError(/* @__PURE__ */ map14(function($81) {
  ...
  var alphaNumPlusString = /* @__PURE__ */ map14(function($82) {
    return fromCharArray(fromFoldable4(toList($82)));
          ...
          return function(ml) {
            return function(mt) {
              ...
              var acc = (function() {
                ...
                ;
                throw new Error("Failed pattern match at Data.Abc.Parser (line 306, column 9 - line 308, column 22): " + [macc.constructor.name]);
              })();
              return {
                pitchClass: pc,
                accidental: acc,
  ...
  var getTitle = function(tune) {
    return map16(trim)(firstOf(function($37) {
      return _headers3(traversed3(_Title2($37)));
    })(tune));
  };
  ...
  var notelength5 = /* @__PURE__ */ (function() {
  ...
  var getKeySig = function(tune) {
    return firstOf(function($166) {
      return _headers4(traversed4(_ModifiedKeySignature2($166)));
    })(tune);
  };
  ...
  var pianoKeyScale = function(keySig) {
    return function(mode2) {
      ...
      var keys3 = map17(lookup1)(diatonicScaleOffsets);
  ...
  var keySet = function(ks) {
    ...
    var basicKeySet = toUnfoldable5(map17(pianoKeyToPitch(isFlatCtx))(v.value1));
    var $155 = isFSharp(ks);
    if ($155) {
      return fSharpKeySet;
    }
  ...
  var buildRepetition = function(decoration2) {
    var repetitionMap = fromFoldable5([new Tuple("coda", 2), new Tuple("segno", 4), new Tuple("D.C.", 6), new Tuple("dacoda", 7), new Tuple("dacapo", 8), new Tuple("D.S.", 9), new Tuple("fine", 12)]);
  ...
  var getVoiceClef = function(tune) {
    ...
    var clefString = join3(lastOf(function($77) {
      return _headers7(traversed22(_Voice2(_properties2(_clef1($77)))));
    })(tune));
  ...
  var initialAbcContext = function(tune) {
    return function(config2) {
      ...
      var modifiedKeySignature = fromMaybe(cMajor)(map19(identity10)(getKeySig(tune)));
  ...
  var buildMusicSpecFromDecorations = function(decorations2) {
    return function(noteIndex) {
      var repetitions = map110(buildRepetition)(fromFoldable6(decorations2));
      return {
  ...
  var foldOverMusics = function(barDecorations) {
    var repetitions = map25(buildRepetition)(fromFoldable7(barDecorations));
    var initialSpec = {
  ...
  var renderUntitledScore = function(renderer) {
    return function(eStaveSpecs) {
      ...
      ;
      throw new Error("Failed pattern match at VexFlow.Score (line 196, column 3 - line 201, column 56): " + [eStaveSpecs.constructor.name]);
    };
  };
  var createScoreAtStave = function(staveNo) {
    return function(config2) {
      return function(abcTune) {
        ...
        ;
        throw new Error("Failed pattern match at VexFlow.Score (line 167, column 5 - line 171, column 80): " + [v.constructor.name]);
      };
    };
  };
  ...
  var displayAtStave = function(renderer) {
    return function(text) {
      return function(staveNo) {
        ...
        if (v instanceof Right) {
          return function __do2() {
            var mError = renderTuneAtStave(staveNo)(config)(renderer)(v.value0)();
            if (mError instanceof Just) {
              var title2 = fromMaybe("unknown title")(getTitle(v.value0));
              renderText(renderer)(title2 + (": " + mError.value0))(" 25pt Arial")(20)(900)();
              return mError;
            }
            ;
            return Nothing.value;
  ...
  var main = function __do() {
    ...
    displayAtStave(renderer)(notelength5)(6)();
    return unit;
  };
